...
namespace RemoteStorageHelper.Helpers
{
	public class FileStorageHelper
	{
		...
		public FileStorageHelper(RestoreConfigurationEntity config, ConnectionEntity connections)
		{
			m_common = new Common();
		...
		/// </summary>
		/// <returns></returns>
		public List<RemoteItemEntity> GetFileItems()
		{
			Console.WriteLine("Fetching list of items in File Storage ...");

			var fileItems = new List<RemoteItemEntity>();
